...
public class Testcases1 extends TestBase {
  ...
  public void testcase001() {
    ...
    //Double click on the webelemebt
      ...
      act.moveToElement(DoubleClick).click().sendKeys(datatable.getCellData("Sheet1", "vegName", 3)).doubleClick().build().perform();
  ...
  public void testcase002() {
	  String banana =datatable.getCellData("Sheet1", "vegName", 2);
	   Actions act = new Actions(driver);
	   WebElement DoubleClick = driver.findElement(By.xpath("//input[@id = 'input']"));
